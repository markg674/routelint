...
no understanding yet of path parameters (`/users/{id}`), method+pattern
prefixes as used by Go 1.22's enhanced `ServeMux` patterns, or route
groups/mounts that prefix a whole set of children with a shared path.
